...
file(GLOB EOKAS_WIDGET_HEADER_FILES
        "${EOKAS_TARGET_DIR}/widgets/*.h"
)

file(GLOB EOKAS_CHART_HEADER_FILES
        "${EOKAS_TARGET_DIR}/charts/*.h"
)

file(GLOB EOKAS_SOURCE_FILES
        "${EOKAS_TARGET_DIR}/*.cpp"
        "${EOKAS_TARGET_DIR}/widgets/*.cpp"
        "${EOKAS_TARGET_DIR}/charts/*.cpp"
...
message("EOKAS_WIDGET_HEADER_FILES = ${EOKAS_WIDGET_HEADER_FILES}")
message("EOKAS_CHART_HEADER_FILES = ${EOKAS_CHART_HEADER_FILES}")
message("EOKAS_SOURCE_FILES = ${EOKAS_SOURCE_FILES}")
message("EOKAS_LIBRARY_FILES = ${EOKAS_LIBRARY_FILES}")


add_library(${EOKAS_TARGET_NAME} STATIC ${EOKAS_HEADER_FILES} ${EOKAS_WIDGET_HEADER_FILES} ${EOKAS_CHART_HEADER_FILES} ${EOKAS_SOURCE_FILES})
...
install(FILES ${EOKAS_WIDGET_HEADER_FILES} DESTINATION include/${EOKAS_TARGET_NAME}/widgets)
install(FILES ${EOKAS_CHART_HEADER_FILES} DESTINATION include/${EOKAS_TARGET_NAME}/charts)
