...
namespace eokas
{
    ...
    */
    ...
    public:
        ...
        Matrix4(f32_t _00, f32_t _01, f32_t _02, f32_t _03, f32_t _10, f32_t _11, f32_t _12, f32_t _13, f32_t _20,
                f32_t _21, f32_t _22, f32_t _23, f32_t _30, f32_t _31, f32_t _32, f32_t _33);
    ...
    */
    struct Math
    {
        ...
        template<typename T>
        static T max_s(T a, T b) { return a > b ? a : b; }

        template<typename T>
        static T min_s(T a, T b) { return a < b ? a : b; }
        ...
        static Vector3 sampleBezierCurve(const Vector3 p0, const Vector3 p1, const Vector3 &p2, const Vector3 &p3,
                                         f32_t t);
